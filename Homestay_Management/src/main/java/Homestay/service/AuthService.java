...
import Homestay.dto.AuthRequest;
import Homestay.dto.AuthResponse;
import Homestay.dto.RegisterRequest;
import Homestay.dto.ResetPasswordRequest;
...
public class AuthService {
    ...
    public void forgotPassword(String email) {
        try {
            ...
            user.setResetTokenExpiry(new Date(System.currentTimeMillis() + 3600000)); // 1 giờ
            userRepository.save(user);
