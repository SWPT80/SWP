                  ...
                  <div className="user_auth">
                    ...
                    {userDropdownOpen && (
                      <div className="user_dropdown" ref={userDropdownRef}>
                        {isLoggedIn ? (
                          <>
                            <a href="#" className="dropdown_item" onClick={() => { navigate('/profile'); setUserDropdownOpen(false); }}>
              ...
              {isLoggedIn ? (
                <>
                  <li className="menu_item">
                    <a href="#" onClick={() => { navigate('/profile'); setIsMenuOpen(false); }}>
                      <i className="fas fa-user mr-2"></i>Profile
                    </a>
                  </li>
                  <li className="menu_item">
...
export default Header;/* Existing styles remain unchanged */