...
import com.traexcohomestay.hoteltraexco.service.SeasonPricingService;
...
public class SeasonPricingController {
    ...
    @GetMapping("/all")
    public ResponseEntity<?> getAllSeasonalPricing(@RequestParam int hostId) {
        return ResponseEntity.ok(seasonPricingService.getAllByHost(hostId));
    }
}
