...
@Repository
public interface SearchResponrity extends JpaRepository<Room, RoomId> {
    ...
    @Query(value = """
        ...
        """, nativeQuery = true)
    List<Room> searchRoomsByFilters(
...
""", nativeQuery = true)
    List<Room> searchHotelByServiceName(@Param("serviceName") String serviceName);
