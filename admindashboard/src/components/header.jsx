...
import { Link } from 'react-router-dom'; // dùng nếu bạn có routing
// import './Header.css'; // nếu bạn cần style riêng

const Header = ({ onToggleSidebar }) => {
  return (
    <div className="header">
      <div className="header-left">
        <a href="../assets/img/logo1.jpg" className="logo">
          <img src="assets/img/logo1.jpg" width="50" height="70" alt="logo" />
                      ...
                      <div className="media">
                        <span className="avatar avatar-sm">
                          <img
                            ...
                            alt="User"
                            src={`assets/img/profiles/${noti.avatar}`}
                          />
                        </span>
