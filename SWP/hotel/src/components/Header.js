    ...
    const fetchUser = async () => {
      ...
      if (token) {
        try {
          ...
          setUser({
            fullName:
              response.data.fullName || response.data.email.split("@")[0],
          ...
          console.error(
            "Header - Error fetching user info:",
        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <div className="right_nav d-flex align-items-center">
              ...
              {user && (
                <Dropdown
                  show={messageDropdownOpen}
                  onToggle={() => setMessageDropdownOpen(!messageDropdownOpen)}
                >
                  <Dropdown.Toggle
                    as="div"
                    style={{
              ...
              >
                <Dropdown.Toggle
                  ...
                  style={{
                    ...
                    borderRadius: "50%",
                    background: user
                      ? "linear-gradient(135deg, #ffa500, #ff6b35)"
                  ...
                  {user ? (
                    <>
                      <Dropdown.Item
                        ...
                        style={{ color: "#333", padding: "12px 20px" }}
                      >
                      ...
                      {user.role === "ADMIN" && (
                        <Dropdown.Item
                          ...
                          style={{ color: "#333", padding: "12px 20px" }}
                        >
                          <i className="fas fa-tachometer-alt me-2"></i>Trang
                          quản trị Admin
                        </Dropdown.Item>
                      )}
                      {user.role === "HOST" && (
                        <Dropdown.Item
                          ...
                          style={{ color: "#333", padding: "12px 20px" }}
                        >
                          <i className="fas fa-home me-2"></i>Trang quản trị
                          Host
                        </Dropdown.Item>
                      )}
                      <Dropdown.Item
                        ...
                        style={{ color: "#333", padding: "12px 20px" }}
                      >
                        <i className="fas fa-calendar-check me-2"></i>Đặt phòng
                        của tôi
                      </Dropdown.Item>
                      <Dropdown.Item
                        as={Link}
                      ...
                      <Dropdown.Item
                        ...
                        style={{ color: "#d9534f", padding: "12px 20px" }}
                      >
      ...
      <div className={`menu trans_500 ${isMenuOpen ? "active" : ""}`}>
        <div className="menu_content d-flex flex-column align-items-center justify-content-center text-center">
          ...
          <ul id="menuItems">
            ...
            {user && (
              <li className="menu_item">
                <Link to="/booked" onClick={() => setIsMenuOpen(false)}>
                  Booked
                </Link>
              </li>
            )}
            ...
            {user ? (
              <>
                ...
                {user.role && user.role.toUpperCase() === "ADMIN" && (
                  <li className="menu_item">
                    <Link
                      ...
                      onClick={() => setIsMenuOpen(false)}
                    >
                      <i className="fas fa-tachometer-alt mr-2"></i>Trang quản
                      trị Admin
                    </Link>
                  </li>
                )}
                ...
                <li className="menu_item">
                  <Link to="/messages" onClick={() => setIsMenuOpen(false)}>
                    <i className="fas fa-envelope mr-2"></i>Tin nhắn{" "}
                    {unreadMessages > 0 && (
              ...
              <li className="menu_item">
                ...
                >
                  <i className="fas fa-sign-in-alt mr-2"></i>Đăng nhập hoặc Đăng
                  ký
                </a>
              </li>
            )}
