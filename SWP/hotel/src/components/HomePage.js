...
const Search = () => {
  ...
  const handleCheckInChange = (e) => {
    ...
    if (
      ...
      checkOutRef.current.value <= selectedDate
    ) {
      checkOutRef.current.value = "";
    }
  };
    ...
    <div className="search">
      <div className="search_container">
        ...
        <div className="search_panels">
          {/* Nhà */}
          <div
            className={`search_panel ${activeTab === "nhà" ? "active" : ""}`}
          >
    ...
    const fetchChatList = async () => {
      try {
        ...
        const response = await axios.get(
          `http://localhost:8080/api/chat/hosts-booked?userId=${user.id}`
        );
        ...
        setHostList([
          {
            ...
            avatar:
              "https://ui-avatars.com/api/?name=Nguyen+Van+A&background=0084ff&color=fff",
          },
          {
            id: "2-2",
            userId: 2,
            ...
            avatar:
              "https://ui-avatars.com/api/?name=Tran+Thi+B&background=0084ff&color=fff",
          },
        ]);
      }
    };
